...
5. admin should be able to adjust user stats within his/her tournament (e.g. after round results have been submitted)
6. security
7. Other Wish Here.
8. Allow Players To Update Round Results (From Their Phones?)
9. User's Create Accounts and Log In. (map to player)
10. Player Cannot Get A Bye Twice.
11. Mark When Player No Longer Has A Chance At Top 8
12. add player dci numbers 
13. jquery to submit all "update results" forms with single button
